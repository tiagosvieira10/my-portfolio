      ...
      <EducationContainer>
        ...
        <CardEducation>
          <Education>
            ...
            <h4>curso abrangente que partiu do zero até a proficiência em programação. Dominei a criação de sites robustos, desenvolvimento de aplicações modernas e adquiri habilidades tanto no Front-end quanto no Back-end. Além das competências técnicas, desenvolvi soft skills como trabalho em equipe, resolução de problemas e metodologias ágeis.</h4>
          </Education>

          <Education>
            <h3>ROCKETSEAT - IGNITE <strong>/</strong> MAIO 2023</h3>
            <h1>Especilista em Desenvolvimento</h1>
          ...
          <Education>
            ...
            <h4>A graduaçao em Engenharia de Software fornece um profundo entendimento das metodologias e práticas vitais para o desenvolvimento de sistemas de software avançados. Abrange áreas como design orientado a objetos, arquitetura de software, testes automatizados e gerenciamento de projetos.</h4>
          </Education>
